...
<div class="well panel-body time-range">
	<div id="datetimepicker0" class="input-append">
		<div class="btn-group" role="group" aria-label="...">
			...
			<?= $form->field($trainings_model,'training_date')->widget(\yii\jui\DatePicker::className(),[
					'language' => 'pl',
...
<?php
	...
	$this->registerJsFile('js/trainings_form.js', ['depends' => [yii\web\JqueryAsset::className()]]);
 ?>
